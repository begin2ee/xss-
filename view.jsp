...
<body>
 ...
 %></td>
			...
			<a href="bbs.jsp" class="btn btn-primary" style="width: 10%;">목록</a>
			
		
						
			<%
				if (userID != null && userID.equals(bbs.getUserID()) || userID.equals("111")) {
			%>
					<a href="update.jsp?bbsID=<%= bbsID %>" class="btn btn-primary" style="width: 10%;">수정</a>			
					<a onclick="return confirm('정말 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary" style="width: 10%;">삭제</a>
			<%	
				}
			%>
		</div>
